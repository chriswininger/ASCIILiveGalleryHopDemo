...
var texts = new Texts(1000, maxLines, 0, function (entry) {
	entry.startY += 1;
	if (entry.startY > maxLines) entry.startY = 0;
});

var textsOverFlow = new Texts(1000, maxLines, -maxLines, function (entry) {
    entry.startY = texts.texts.allTexts.startY - 50;
});
